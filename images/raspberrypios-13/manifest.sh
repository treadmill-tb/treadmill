# shellcheck shell=bash source=../lib/build-image.sh
#
...
export arch="aarch64"
export type="sd" # FAT boot partition + ext4 root partition

export title="Raspberry Pi OS 13 (NBD)"
export version="13"
...
export base_image_url="https://downloads.raspberrypi.com/raspios_lite_arm64/images/raspios_lite_arm64-2026-04-21/2026-04-21-raspios-trixie-arm64-lite.img.xz"
export base_image_sha256="4cd31df026fd82243805a326dc0cafd7383f7e3d30c9413e7044d507aae281e2"
...
export rustup_init_url="https://static.rust-lang.org/rustup/archive/1.29.0/aarch64-unknown-linux-gnu/rustup-init"
export rustup_init_sha256="9732d6c5e2a098d3521fca8145d826ae0aaa067ef2385ead08e6feac88fa5792"
...
# image already ships it). ttyd + tmux back the web terminal that
# provision-common.sh sets up; the Ubuntu manifest lists them in its own set.
export packages=(nbd-client systemd-resolved ttyd tmux)
...
export puppet_daemon_args='--transport tcp --tcp-control-socket-addr "$(ip route show 0.0.0.0/0 | cut -d" " -f3 | head -n1):3859"'

export serial_consoles=(ttyAMA0 ttyAMA10)
...
export nbd_cmdline="console=serial0,115200 ip=dhcp root=/dev/nbd0 rw nbdroot=dhcp,root,nbd0 rootfstype=ext4 fsckfix rootwait net.ifnames=0 loglevel=7"
