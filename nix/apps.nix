      ...
      devstack-e2e = mkDevstack {
        ...
        preamble = ''
          ...
          function TML_DEVSTACK_RUNFN() {
            ...
            job_body="{\"init_spec\":{\"type\":\"image\",\"manifest_digest\":\"$manifest_digest\"},\"restart_policy\":{\"max_restarts\":0},\"parameters\":{},\"host_cel_predicate\":\"host.id == '$host_id'\",\"lease_duration\":null}"
